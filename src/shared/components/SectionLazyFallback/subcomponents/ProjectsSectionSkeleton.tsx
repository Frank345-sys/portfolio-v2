  ...
  return (
    <div className={cn(LAYOUT.spacing.large, LAYOUT.px)} aria-hidden>
      ...
      <div className="relative flex w-full flex-col gap-10 lg:flex-row lg:gap-10">
        <div className="border-stroke-soft bg-bg-weak/50 sticky top-24 hidden h-fit min-h-48 w-full shrink-0 flex-col gap-4 rounded-lg border p-5 lg:block lg:w-[50%] xl:w-[45%]">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <ShimmerBar className="h-7 w-20 rounded-full" />
            <ShimmerBar className="h-7 w-14 rounded-full" />
          </div>
          <ShimmerBar className="mt-4 h-10 w-36 rounded-md" />
        </div>
        ...
        <div className={cn(LAYOUT.spacing.large, 'flex-1 xl:space-y-18')}>
          ...
          <div className={LAYOUT.spacing.default}>
            <div className="shadow-elevation-xl border-stroke-soft overflow-hidden rounded-lg border">
              ...
              />
              <div className="h-14 bg-linear-to-t from-black/30 to-transparent p-4">
                <ShimmerBar className="bg-information-base/25 h-4 w-40" />
              </div>
            </div>
          </div>
        </div>
