/**
 * Pruebas de `useImageCarousel` — navegación circular, autoplay, modo controlado y a11y.
 *
 * @fileoverview `renderHook` sobre slides, handlers `goNext` / `goPrev` / `goToSlide` y temporizadores con `vi.useFakeTimers`.
 * @remarks Valida `IMAGE_CAROUSEL_AUTOPLAY_MS`, pausas tras navegación manual y acotación de índice en modo controlado.
 */
