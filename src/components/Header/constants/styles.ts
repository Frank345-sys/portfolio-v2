 ...
 * @remarks Strings puros `as const` — sin lógica ni dependencias de runtime.
...
export const headerContainer =
  'flex items-center justify-between gap-4 py-2.5 md:py-4' as const

/** Estado activo del scroll-spy (misma base que `TYPOGRAPHY.link.nav`). */
export const navLinkActive = 'text-information-base font-medium' as const
